...
.factory('API', function($http) {
  var api = {};
  var baseURL = 'http://ladderserver.herokuapp.com';
...
.controller('PlaylistsCtrl', function($scope, $ionicSlideBoxDelegate, API, $ionicModal, $http) {
  ...
  $scope.text = function() {
    var t = document.getElementById("phoneNum").value
    API.message(t, "Hey, I need some help with my homework. Do you think you can help me?");
  }
